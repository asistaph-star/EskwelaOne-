    ...
    <div style={{ minHeight: "100vh", width: "100vw", display: "flex", fontFamily: "'Inter',sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ flex: "0 0 58%", position: "relative", zIndex: 2, display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "48px 64px", boxSizing: "border-box" }}>
        ...
        <div style={{ maxWidth: 500 }}>
          <h1 style={{ fontFamily: "'Fraunces',serif", fontSize: 46, fontWeight: 700, color: "#fff", lineHeight: 1.1, margin: "0 0 16px" }}>Education<br />Shapes the Future</h1>
        ...
        {/* Bottom info row */}
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 12, borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: 20 }}>
          {[
      ...
      <div style={{ flex: "0 0 42%", display: "flex", alignItems: "center", justifyContent: "center", padding: 32, boxSizing: "border-box", position: "relative", zIndex: 2 }}>

        {/* White card */}
        <div style={{ width: "100%", maxWidth: 420, background: "#fff", borderRadius: 16, boxShadow: "0 20px 50px rgba(0,0,0,0.3)", padding: "36px 36px", boxSizing: "border-box", position: "relative" }}>

          {/* Top-right controls */}
          <div style={{ position: "absolute", top: 20, right: 20, display: "flex", alignItems: "center", gap: 10 }}>
            <button type="button" style={{ background: C.m50, border: `1px solid ${C.borderMed}`, borderRadius: 14, width: 38, height: 20, display: "flex", alignItems: "center", padding: "0 2px", cursor: "pointer" }}>
              <div style={{ width: 16, height: 16, borderRadius: 8, background: C.m700, marginLeft: "auto" }} />
            </button>
            <div style={{ border: `1px solid ${C.borderMed}`, borderRadius: 4, padding: "2px 8px", fontSize: 10.5, fontWeight: 700, color: C.t2, background: C.m50, display: "flex", alignItems: "center", gap: 4 }}>
          ...
          <form onSubmit={handleSignIn}>
            ...
            <div style={{ marginBottom: 12 }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="Enter your institutional email"
                  onFocus={() => setFocused("e")} onBlur={() => setFocused(null)}
                  style={{ width: "100%", boxSizing: "border-box", border: focused === "e" ? `1.5px solid ${C.m700}` : `1px solid ${C.borderMed}`, borderRadius: 6, padding: "10px 12px 10px 34px", fontSize: 12.5, color: C.t1, background: focused === "e" ? "#fff" : C.m50, outline: "none", transition: "all 0.15s", fontFamily: "'Inter',sans-serif" }} />
              </div>
            </div>
            ...
            <div style={{ marginBottom: 14 }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input type={show ? "text" : "password"} value={pass} onChange={e => setPass(e.target.value)} placeholder="Enter your password"
                  ...
                  style={{ width: "100%", boxSizing: "border-box", border: focused === "p" ? `1.5px solid ${C.m700}` : `1px solid ${C.borderMed}`, borderRadius: 6, padding: "10px 40px 10px 34px", fontSize: 12.5, color: C.t1, background: focused === "p" ? "#fff" : C.m50, outline: "none", transition: "all 0.15s", fontFamily: "'Inter',sans-serif" }} />
                <button type="button" onClick={() => setShow(s => !s)} style={{ position: "absolute", right: 12, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", color: C.t3, display: "flex", alignItems: "center" }}>
            ...
            <div style={{ marginBottom: 18 }}>
              <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: C.t2, cursor: "pointer" }}>
                <input type="checkbox" checked={rememberMe} onChange={e => setRememberMe(e.target.checked)} style={{ accentColor: C.m700 }} />
            ...
            <button type="submit" disabled={loading}
              style={{ width: "100%", padding: "11px", background: loading ? C.m600 : C.m700, color: "#fff", borderRadius: 6, border: "none", cursor: loading ? "default" : "pointer", fontSize: 13.5, fontWeight: 700, fontFamily: "'Plus Jakarta Sans',sans-serif", transition: "background 0.15s", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}
          ...
          <div style={{ marginTop: 18, background: "#f9fafb", border: "1px solid #f3f4f6", padding: 12, borderRadius: 6, display: "flex", gap: 10, alignItems: "flex-start", textAlign: "left" }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 9.5, color: C.t3, marginTop: 2, lineHeight: 1.4 }}>This system is for authorized university personnel and students only. All access is monitored and recorded.</div>
            </div>
          </div>
        </div>
      </div>
