...
export function PReports() {
  ...
  const REPORTS = [
    ...
    { id:"sf9",   title:"SF9 Scholastic Record",  desc:"Term grade sheet - all subjects, all sections" },
  ...
  if (viewing) {
    ...
    return (
      <div style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden" }}>
        ...
        <div style={{ flex:1, minHeight: 0, overflowY:"auto", padding:32, background: "transparent" }}>
          <div style={{ background:"#fff", border:`1px solid ${C.borderMed}`, padding:28, maxWidth:800, margin:"0 auto" }}>
            <div style={{ textAlign:"center", borderBottom:`2px solid ${C.t1}`, paddingBottom:16, marginBottom:20 }}>
              ...
              <div style={{ fontSize:18, fontWeight:800, color:C.t1, fontFamily:"'Fraunces',serif", marginTop:5 }}></div>
              ...
              <div style={{ fontSize:11, color:C.t3, marginTop:3 }}>School Year 2025–2026 · Term 1</div>
            </div>
